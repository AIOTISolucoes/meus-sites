...
(function () {
  ...
  const AGENTE = 'butterfly_dreams';      // nome da chave no agents.yaml
  const COR = 'c9a86a';                 // cor da marca, SEM o # (vai na URL)
  const TITULO = 'Atendimento Butterfly Dreams';
  const CHAMADA = 'Quer agendar? Fala comigo';
  const COR_TEXTO = '#12100d';
  const COR_CLARA = '#e6d2a8';
