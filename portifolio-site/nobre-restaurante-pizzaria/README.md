...
**Status:** site pronto, vídeo pronto, revisão pendente com o negócio. **Não publicado, não enviado à casa.**
...
- Horizontal 1440×900: `vendas/video-nobre-restaurante.mp4` (`python vendas/gravar-horizontal-hd.py --classic --only …`).
- **Horizontal Full HD 1920×1080 (recomendado):** `vendas/hd/hd-nobre-restaurante-pizzaria.mp4` (`python vendas/gravar-horizontal-hd.py --only …`).
- Reels 1080×1920, 30 fps: `vendas/reels/reels-nobre-restaurante-pizzaria.mp4` (`python vendas/gravar-reels.py --only …`).
