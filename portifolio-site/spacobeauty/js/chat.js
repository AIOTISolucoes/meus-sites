...
(function () {
  ...
  const AGENTE = 'spaco_beauty';           // nome da chave no agents.yaml
  const COR = '4a2a0c';                 // cor da marca, SEM o # (vai na URL)
  const TITULO = 'Atendimento Spaço Beauty';
  const CHAMADA = 'Quer agendar? Fala comigo';
  const COR_TEXTO = '#f6efe4';
  const COR_CLARA = '#8a5a30';
