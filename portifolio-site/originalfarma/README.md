...
- Horizontal 1440×900: `vendas/video-originalfarma.mp4` (`python vendas/gravar-horizontal-hd.py --classic --only …`).
- **Horizontal Full HD 1920×1080 (recomendado):** `vendas/hd/hd-originalfarma.mp4` (`python vendas/gravar-horizontal-hd.py --only …`).
